...
@interface OMCrossPromotionViewObserver : NSObject
...
static OMCrossPromotionExposureMonitor * _instance = nil;

@implementation OMCrossPromotionExposureMonitor
...
- (void)checkMonitoredViews {
    ...
    OMCrossPromotionViewObserver *observer;
