...
+ (void)setConsent:(BOOL)consent {
    ...
    if (chartboostClass && [chartboostClass respondsToSelector:@selector(setPIDataUseConsent:)]) {
        [chartboostClass setPIDataUseConsent:(consent?YesBehavioral:NoBehavioral)];
    }
}
